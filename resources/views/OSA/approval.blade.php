        ...
        <form method="post" action="/osaemp/activity_approval/approved" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button type="submit" name="action" value="approve_{{$event->id}}" class="btn btn-info">Approve</button>
                    <button type="submit" name="action" value="reject_{{$event->id}}" class="btn btn-danger">Reject</button>
                    </td>
                </tr>
                @endforeach
            </tbody> 
