...
$(document).ready(function (){
    ...
    $('#course-list').DataTable({
        processing: true,
        serverSide: true,
        ajax: "<?php echo e(url('course-list')); ?>",
        columns: [
                {data: 'id', name: 'id'},
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('navbar.admin_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SOARS Github\SOARS\resources\views/course-list.blade.php ENDPATH**/ ?>