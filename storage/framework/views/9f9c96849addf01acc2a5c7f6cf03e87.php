...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(url('https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.9.0/fullcalendar.css')); ?>" />
    <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.24.0/moment.min.js')); ?>"></script>
    <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/fullcalendar/3.9.0/fullcalendar.js')); ?>"></script>
    <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js')); ?>"></script>
    <script src="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.js')); ?>"></script>
    <link rel="stylesheet" href="<?php echo e(url('https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/toastr.min.css')); ?>" />
