            ...
            <div class="col-md-6 offset-md-3">
                <form action="/admin/update_email" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" class="form-control" id="email" name="email" placeholder="<?php echo e(Auth::user()->email); ?>">
                    </div>
...
<?php echo $__env->make('navbar.admin_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\soarsWebProject\resources\views/Admin/admin_profile.blade.php ENDPATH**/ ?>