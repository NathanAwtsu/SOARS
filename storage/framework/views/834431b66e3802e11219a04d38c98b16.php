...
<div class="container-tbl-up" style="padding: 0px 100px;">
    ...
    <table class="table"> <br>
        ...
        <center>
            <div class="btn-group">
                <a class="btn btn-create" type="button" id="createUserButton" style="margin-left: 10px;" href="<?php echo e(url('/rso_list/new_organization')); ?>">Create New Organization</a>
            </div>
                            ...
                            <div class="col-lg-5 col-md-5 col-sm-5">
                                <div class="card" style="position: relative; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                    ...
                                    <div class="card-body" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.7); overflow: hidden; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                        <a href="<?php echo e(url('/rso_list/pending_edit/'.$pend->id)); ?>" style="text-decoration: none; display: block;">
                ...
                <div class="card-table" style="margin: 0 0 0 0;">
                    ...
                    <div class="col-lg-5 col-md-5 col-sm-5">
                        <div class="card" style="position: relative; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                            ...
                            <div class="card-body" style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0, 0, 0, 0.7); overflow: hidden; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                <a href="<?php echo e(url('/rso_list/rso_page/'.$orgAcads->id)); ?>" style="text-decoration: none; display: block;">
...
<?php echo $__env->make('navbar.admin_nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\SOARS Github\SOARS\resources\views/student_orgs/rso_list.blade.php ENDPATH**/ ?>