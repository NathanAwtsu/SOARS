        ...
        <Center>
            ...
            <div class="card-table-title"> <H1>PENDING</H1><br> </div>
                <div class="card-table">
                    <?php $__currentLoopData = $pendings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $pendings): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="card" style="position: relative; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                            <?php if($pendings->requirement_status != "100"): ?>
                            <progress id="file" value="<?php echo e($pendings->requirement_status); ?>" max="100"></progress>
                            <?php endif; ?>
